	...
	snowImage(std::make_unique<Image>("assets/textures/snow.png"))
{
	...
	//vert[0].position = glm::vec3(-0.5f, -0.5f, 0.0f);
	//vert[1].position = glm::vec3(0.5f, -0.5f, 0.0f);
	//vert[2].position = glm::vec3(0.5f, 0.5f, 0.0f);
	//vert[3].position = glm::vec3(-0.5f, 0.5f, 0.0f);
	//
